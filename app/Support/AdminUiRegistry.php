...
final class AdminUiRegistry
{
    ...
    private function modules(): array
    {
        return [
            ...
            [
                ...
                'icon' => 'chart-no-axes-combined', 'route' => 'admin.dashboard', 'protected' => false,
            ...
            [
                ...
                'icon' => 'bot', 'route' => 'admin.ai.configurator', 'protected' => false,
                'patterns' => [
    ...
    /** @return list<array{route:string,label:string,tone:string}> */
    ...
    /** @return array{route:string,label_key:string,tone:string}|null */
